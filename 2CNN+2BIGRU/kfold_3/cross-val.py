...
def prepare_data():
    ...
    train_file = '/home/jiajunh/2CNN+2BIGRU/kfold_3/all_train.pkl'
    pssm_file = '/home/wanglei/data/Oxygen/npy'
    test_file = '/home/jiajunh/2CNN+2BIGRU/kfold_3/all_test.pkl'
...
def save_hist(hist,function):
    model_snapshot_directory = "/home/jiajunh/2CNN+2BIGRU/kfold_3"
    h1 = hist.history
    epoch = hist.epoch
...
def create_model_2CNN_2BiGRU():
    ...
    embedded = Embedding(max_features, 128, input_length=800)(input_embed)
    x1 = concatenate([embedded, input_extra], axis=2)
    x1 = Conv1D(filters=64, kernel_size=5,
                activation='relu', strides=1,name='conv1')(x1)
    x1 = BatchNormalization()(x1)
    x1 = Activation(activation='relu')(x1)
    x1 = Dropout(0.13724,name='drop1')(x1)
    
    x1 = Conv1D(filters=64, kernel_size=11,
                activation='relu', strides=1,name='conv2')(x1)
    x1 = BatchNormalization()(x1)
    x1 = Activation(activation='relu')(x1)
    x1 = Dropout(0.00284, name='drop2')(x1)
    x_cnn = MaxPooling1D(pool_size=16, strides=32,name='maxpooling')(x1)

    x1_left = GRU(units=100, recurrent_activation='hard_sigmoid',
                  use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros',
                  activation='tanh', return_sequences=True, dropout=0.02024, name='gru1')(x_cnn)
    x1_right = GRU(units=400, recurrent_activation='hard_sigmoid',
                   use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros',
                   activation='tanh', return_sequences=True, dropout=0.38919, name='gru2',
                   go_backwards='True')(x_cnn)
    xgru1 = keras.layers.concatenate([x1_left, x1_right], axis=-1)

    x2_left = GRU(units=400, recurrent_activation='hard_sigmoid',
                  use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros',
                  activation='tanh', return_sequences=True, dropout=0.58541, name='gru3')(xgru1)
    x2_right = GRU(units=100, recurrent_activation='hard_sigmoid',
                   use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros',
                   activation='tanh', return_sequences=True, dropout=0.19276, name='gru4',
...
if __name__=='__main__':
    ...
    best_model_path = "/home/jiajunh/2CNN+2BIGRU/kfold_3/best_cross_model.h5"
