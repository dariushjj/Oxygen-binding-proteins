...
def prepare_data():
    ...
    train_file = '/home/jiajunh/kfold_5/all_train.pkl'
    pssm_file = '/home/wanglei/data/Oxygen/npy'
    test_file = '/home/jiajunh/kfold_5/all_test.pkl'
...
def save_hist(hist,function):
    model_snapshot_directory = "/home/jiajunh/kfold_5"
    h1 = hist.history
    epoch = hist.epoch
...
def create_model_2CNN_2BiGRU():
    ...
    embedded = Embedding(max_features, 128, input_length=800)(input_embed)
    x1 = concatenate([embedded, input_extra], axis=2)
    x1 = Conv1D(filters=64, kernel_size=3,strides=1, name='conv1')(x1)
    x1 = BatchNormalization()(x1)
    x1 = Activation(activation='relu')(x1)
    x1 = Dropout(0.20308, name='drop1')(x1)
    
    x1 = Conv1D(filters=128, kernel_size=7,strides=1, name='conv2')(x1)
    x1 = BatchNormalization()(x1)
    x1 = Activation(activation='relu')(x1)
    x1 = Dropout(0.00652, name='drop2')(x1)
    x_cnn = MaxPooling1D(pool_size=8, strides=32, name='maxpooling')(x1)

    x1_left = GRU(units=200, recurrent_activation='hard_sigmoid',
                  use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros',
                  activation='tanh', return_sequences=True, dropout=0.31075, name='gru1')(x_cnn)
    x1_right = GRU(units=300, recurrent_activation='hard_sigmoid',
                   use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros',
                   activation='tanh', return_sequences=True, dropout=0.61376, name='gru2',
    ...
    x2_left = GRU(units=400, recurrent_activation='hard_sigmoid',
                  use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros',
                  activation='tanh', return_sequences=True, dropout=0.64574, name='gru3')(xgru1)
    x2_right = GRU(units=200, recurrent_activation='hard_sigmoid',
                   use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros',
                   activation='tanh', return_sequences=True, dropout=0.59292, name='gru4',
...
if __name__=='__main__':
    ...
    best_model_path = "/home/jiajunh/kfold_5/best_cross_model.h5"
    ...
    for i in range(1):
        ...
        plt.show()
        plt.savefig(model_snapshot_directory+'/'+'loss-acc' + '.png')
