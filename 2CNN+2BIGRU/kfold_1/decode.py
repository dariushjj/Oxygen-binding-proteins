...
def prepare_data():
    ...
    train_file = '/home/jiajunh/kfold_1/all_train.pkl'
    pssm_file = '/home/wanglei/data/Oxygen/npy'
    test_file = '/home/jiajunh/kfold_1/all_test.pkl'
...
def train(X_train,X_extra,y_train,X_test,y_test,pssm_ssacc_test):
    ...
    model_snapshot_directory = "/home/jiajunh/kfold_1"
    max_features = 20
    ...
    x1 = MaxPooling1D(pool_size=8, strides=16,name='maxpooling')(x1)
    x1 = BatchNormalization()(x1)

    x1_left = GRU(units=100, recurrent_activation='hard_sigmoid',
             use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros',
             activation='tanh', return_sequences=True, dropout=0.97710,name='gru1')(x1)
    ...
    x = Dense(units=256, activation='relu',
              kernel_regularizer=regularizers.l1_l2(0.00001),name='dense1')(x)
...
if __name__ == "__main__":
    # set up logging
    results_dir = "/home/jiajunh/kfold_1"
    '''
    ...
    file = open("/home/jiajunh/kfold_2/" +  "console.txt", 'w')
    sys.stdout = file
    ...
    #print(best_run)
    #json.dump(best_run, open("/home/jiajunh/kfold_1/model_hyper.txt", 'w'))
