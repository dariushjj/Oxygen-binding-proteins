...
def prepare_data():
    ...
    train_file = '/home/jiajunh/kfold_2/all_train.pkl'
    pssm_file = '/home/wanglei/data/Oxygen/npy'
    test_file = '/home/jiajunh/kfold_2/all_test.pkl'
...
def train(X_train,X_extra,y_train,X_test,y_test,pssm_ssacc_test):
    ...
    model_snapshot_directory = "/home/jiajunh/kfold_2"
    max_features = 20
...
if __name__ == "__main__":
    # set up logging
    results_dir = "/home/jiajunh/kfold_2"
    '''
    ...
    #print(best_run)
    #json.dump(best_run, open("/home/jiajunh/kfold_2/model_hyper.txt", 'w'))
