...
def prepare_data():
    ...
    train_file = '/home/jiajunh/2CNN+2BIGRU/kfold_2/all_train.pkl'
    pssm_file = '/home/wanglei/data/Oxygen/npy'
    test_file = '/home/jiajunh/2CNN+2BIGRU/kfold_2/all_test.pkl'
...
def save_hist(hist,function):
    model_snapshot_directory = "/home/jiajunh/2CNN+2BIGRU/kfold_2"
    h1 = hist.history
    epoch = hist.epoch
...
def create_model_2CNN_2BiGRU():
    ...
    x1 = Dropout(0.21716,name='drop1')(x1)
    
    x1 = Conv1D(filters=128, kernel_size=7,
                activation='relu', strides=1,name='conv2')(x1)
    x1 = BatchNormalization()(x1)
    x1 = Activation(activation='relu')(x1)
    x1 = Dropout(0.04161, name='drop2')(x1)
    x_cnn = MaxPooling1D(pool_size=8, strides=16,name='maxpooling')(x1)

    x1_left = GRU(units=100, recurrent_activation='hard_sigmoid',
                  use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros',
                  activation='tanh', return_sequences=True, dropout=0.97710, name='gru1')(x_cnn)
    x1_right = GRU(units=200, recurrent_activation='hard_sigmoid',
                   use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros',
                   activation='tanh', return_sequences=True, dropout=0.67130, name='gru2',
    ...
    x2_left = GRU(units=400, recurrent_activation='hard_sigmoid',
                  use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros',
                  activation='tanh', return_sequences=True, dropout=0.04987, name='gru3')(xgru1)
    x2_right = GRU(units=200, recurrent_activation='hard_sigmoid',
                   use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros',
                   activation='tanh', return_sequences=True, dropout=0.66720, name='gru4',
...
if __name__=='__main__':
    ...
    best_model_path = "/home/jiajunh/2CNN+2BIGRU/kfold_2/best_cross_model.h5"
