...
def prepare_data():
    ...
    train_file = '/home/jiajunh/2CNN+2BIGRU/kfold_4/all_train.pkl'
    pssm_file = '/home/wanglei/data/Oxygen/npy'
    test_file = '/home/jiajunh/2CNN+2BIGRU/kfold_4/all_test.pkl'
...
def save_hist(hist,function):
    model_snapshot_directory = "/home/jiajunh/2CNN+2BIGRU/kfold_4"
    h1 = hist.history
    epoch = hist.epoch
...
def create_model_2CNN_2BiGRU():
    ...
    x1 = Dropout(0.01677,name='drop1')(x1)
    
    x1 = Conv1D(filters=16, kernel_size=5,
                activation='relu', strides=1,name='conv2')(x1)
    x1 = BatchNormalization()(x1)
    x1 = Activation(activation='relu')(x1)
    x1 = Dropout(0.09762, name='drop2')(x1)
    x_cnn = MaxPooling1D(pool_size=16, strides=8,name='maxpooling')(x1)

    x1_left = GRU(units=200, recurrent_activation='hard_sigmoid',
                  use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros',
                  activation='tanh', return_sequences=True, dropout=0.89361, name='gru1')(x_cnn)
    x1_right = GRU(units=100, recurrent_activation='hard_sigmoid',
                   use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros',
                   activation='tanh', return_sequences=True, dropout=0.06923, name='gru2',
    ...
    x2_left = GRU(units=200, recurrent_activation='hard_sigmoid',
                  use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros',
                  activation='tanh', return_sequences=True, dropout=0.64729, name='gru3')(xgru1)
    x2_right = GRU(units=300, recurrent_activation='hard_sigmoid',
                   use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros',
                   activation='tanh', return_sequences=True, dropout=0.72649, name='gru4',
                   go_backwards='True')(xgru1)
    x_gru = keras.layers.concatenate([x2_left, x2_right], axis=-1)
    x = concatenate([x_cnn, x_gru], axis=-1)        

    x = TimeDistributed(Dense(units=256, kernel_regularizer=regularizers.l1_l2(0.00001), name='dense1'))(x)
...
if __name__=='__main__':
    ...
    best_model_path = "/home/jiajunh/2CNN+2BIGRU/kfold_4/best_cross_model.h5"
