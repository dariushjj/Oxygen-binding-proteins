...
def prepare_data():
    ...
    train_file = '/home/jiajunh/CNN/kfold_2/all_train.pkl'
    pssm_file = '/home/wanglei/data/Oxygen/npy'
    test_file = '/home/jiajunh/CNN/kfold_2/all_test.pkl'
...
def save_hist(hist,function):
    model_snapshot_directory = "/home/jiajunh/CNN/kfold_2"
    h1 = hist.history
    epoch = hist.epoch
...
def create_model_3CNN():
    ...
    x1 = Conv1D(filters=128, kernel_size=5,activation='relu', strides=1, name='conv1')(x1)
    x1 = Dropout( 0.32423, name='drop1')(x1)
    x1 = Conv1D(filters=64, kernel_size=5,activation='relu', strides=1, name='conv2')(x1)
    x1 = Dropout(0.21851, name='drop002')(x1)

    x1 = Conv1D(filters=128, kernel_size=7,
                activation='relu', strides=1, name='conv3')(x1)
    x1 = Dropout(0.06593, name='drop3')(x1)
    x1 = MaxPooling1D(pool_size=4, strides=8, name='maxpooling')(x1)
...
if __name__=='__main__':
    ...
    best_model_path = "/home/jiajunh/CNN/kfold_2/best_cross_model.h5"
