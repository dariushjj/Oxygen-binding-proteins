...
def create_model_3CNN():
    ...
    x1 = Conv1D(filters=32, kernel_size=7,activation='relu', strides=1, name='conv1')(x1)
    x1 = Dropout(0.43524, name='drop1')(x1)
    x1 = Conv1D(filters=32, kernel_size=15,activation='relu', strides=1, name='conv2')(x1)
    x1 = Dropout(0.18449, name='drop2')(x1)

    x1 = Conv1D(filters=32, kernel_size=11,
                activation='relu', strides=1, name='conv3')(x1)
    x1 = Dropout(0.01022, name='drop3')(x1)
    x1 = MaxPooling1D(pool_size=8, strides=16, name='maxpooling')(x1)
    
    x1 = Flatten()(x1)
    x1 = Dense(units=256, activation='relu',kernel_regularizer=regularizers.l1_l2(0.001), name='dense1')(x1)
...
if __name__=='__main__':
    ...
    best_model_path = "/home/jiajunh/CNN/kfold_3/best_cross_model.h5"
