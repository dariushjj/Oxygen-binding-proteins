...
if __name__ == "__main__":
    # set up logging
    results_dir = "/home/jiajunh/CNN/kfold_5"
    '''
    ...
    file = open("/home/jiajunh/CNN/kfold_5/" +  "console.txt", 'w')
    sys.stdout = file
    ...
    print(best_run)
    json.dump(best_run, open("/home/jiajunh/CNN/kfold_5/model_hyper.txt", 'w'))
