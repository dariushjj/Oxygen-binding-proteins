...
if __name__ == "__main__":
    # set up logging
    results_dir = "/home/jiajunh/CNN/kfold_4"
    '''
    ...
    file = open("/home/jiajunh/CNN/kfold_4/" +  "console.txt", 'w')
    sys.stdout = file
    ...
    print(best_run)
    json.dump(best_run, open("/home/jiajunh/CNN/kfold_4/model_hyper.txt", 'w'))
